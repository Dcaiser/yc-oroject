<x-app-layout>
    ...
    <div class="px-4 py-8 mx-auto max-w-7xl">
        ...
        <div x-data="{ open: false, id: '', name: '', description: '' }" class="space-y-6">
            ...
            <div
                ...
                <div class="bg-white w-[90%] md:w-[72%] rounded-lg shadow-lg p-6 relative" @click.away="open = false">
                    <!-- Tombol Close -->
                    <button @click="open = false" class="absolute text-xl text-gray-600 top-3 right-3 hover:text-black">&times;</button>
                    ...
                    <form method="POST" :action="'/categories/' + id">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" x-model="name" class="w-full p-2 border border-gray-300 rounded">
                        </div>

                        <div class="mb-3">
                            <label class="block mb-1 text-sm font-medium">Deskripsi</label>
                            <textarea name="description" x-model="description" rows="3" class="w-full p-2 border border-gray-300 rounded"></textarea>
                        </div>
