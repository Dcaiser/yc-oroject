<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 md:space-y-8">
        <!-- Hero -->
        <section class="rounded-3xl border border-emerald-100 bg-gradient-to-br from-white via-emerald-50/35 to-emerald-50/60 px-8 py-8 shadow-[0_15px_35px_-22px_rgba(16,185,129,0.45)]">
            <div class="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div class="w-full max-w-md lg:max-w-sm lg:self-stretch">
                    <div class="flex h-full flex-col overflow-hidden rounded-3xl border border-emerald-100 bg-gradient-to-br from-white via-emerald-50/60 to-emerald-100/40 text-center shadow-[0_18px_40px_-22px_rgba(16,185,129,0.55)]">
        ...
        <section class="grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
            @foreach (array_slice($statCards, 0, 4) as $card)
                ...
                <article class="relative overflow-hidden rounded-3xl border {{ $colors['border'] }} bg-white shadow-[0_15px_35px_-20px_rgba(16,185,129,0.45)]">
                    <div class="flex flex-col items-start gap-3 px-8 py-8">
                    ...
                    <div class="h-2 bg-gradient-to-r {{ $colors['glow'] }}"></div>
                </article>
            @endforeach
        </section>
        ...
        <section class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2 rounded-3xl border border-slate-100 bg-white shadow-sm">
                ...
                <div class="grid grid-cols-1 gap-4 p-6 sm:grid-cols-2">
                    @forelse ($quickActions as $action)
                        <a href="{{ $action['url'] }}" class="group flex items-start gap-4 rounded-2xl border border-slate-100 bg-slate-50/50 px-5 py-5 shadow-sm transition transform hover:-translate-y-1 hover:border-emerald-200 hover:bg-emerald-50/50 hover:shadow-lg">
                            <span class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl {{ $action['style'] }} transition group-hover:scale-105">
                            ...
                            <i class="fas fa-arrow-right mt-1 flex-shrink-0 text-slate-300 transition group-hover:translate-x-1 group-hover:text-emerald-600"></i>
                        </a>
                    @empty
            ...
            <div class="rounded-3xl border border-slate-100 bg-white/95 shadow-sm">
                <div class="flex items-start justify-between border-b border-slate-100 px-6 py-5">
                    ...
                    <span class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl border border-emerald-100 bg-emerald-500/10 text-emerald-600">
                        ...
                        <article class="group rounded-2xl border border-orange-100 bg-white/80 p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-orange-200 hover:bg-orange-50/50">
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex items-start gap-3 min-w-0">
                                    <span class="inline-flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-orange-100 text-orange-600">
